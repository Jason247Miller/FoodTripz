...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="nav-justified" style="height: 530px; width: 88%;">
        <tr>
            ...
            <td style="height: 57px; width: 3px;"></td>
            <td style="height: 57px; width: 90px;">&nbsp;</td>
             <td class="modal-sm" style="width: 232px; height: 57px;" ></td>
            
        </tr>
        <tr>
            <td class="text-right" style="width: 91px"><strong>Email:</strong></td>
            ...
            <td style="width: 3px" class="text-right"><strong>City:</strong></td>
        ...
        <tr>
            <td class="text-right" style="width: 91px; height: 66px;"><strong>Password:</strong></td>
            ...
            <td style="width: 3px; height: 66px;" class="modal-sm"><strong>PickupTimes</strong>:</td>
        ...
        <tr>
            <td class="text-right" style="width: 91px"><strong>confirm 
                <br />
                password:</strong></td>
            <td class="modal-sm" style="width: 50px">
            ...
            <td style="width: 3px"><strong>phone:</strong></td>
        ...
        <tr>
            <td style="width: 91px; height: 47px;" class="text-right"><strong>company name:</strong></td>
            ...
            <td style="width: 3px; height: 47px;" class="modal-sm"><strong>latitude</strong></td>
        ...
        <tr>
            <td style="width: 91px; height: 68px;" class="text-right"><strong>zip:</strong></td>
            ...
            <td style="width: 3px; height: 68px;" class="modal-sm"><strong>longitude:</strong></td>
        ...
        <tr>
            <td style="width: 91px; height: 68px;" class="text-right"><strong>street name:</strong></td>
            <td class="modal-sm" style="width: 50px; height: 68px;">
                <strong><asp:TextBox ID="TextBoxStreetName" runat="server" Width="200px"></asp:TextBox>
                    </strong></td>
            <td style="width: 237px; height: 68px;" class="modal-sm"><strong>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="TextBoxCompanyName" ErrorMessage="Street name required" ForeColor="Red"></asp:RequiredFieldValidator>
                    </strong></td>
            <td style="width: 3px; height: 68px;" class="modal-sm">&nbsp;</td>
            <td style="width: 90px; height: 68px;" class="modal-sm">&nbsp;</td>
             <td class="modal-sm" style="height: 68px; width: 232px" >&nbsp;</td>
            
        </tr>
        <tr>
            <td style="width: 91px; height: 68px;" class="text-right">&nbsp;</td>
            <td class="modal-sm" style="width: 50px; height: 68px;">
                &nbsp;</td>
        ...
        <tr>
            <td style="width: 91px; height: 68px;" class="text-right">&nbsp;</td>
            <td class="modal-sm" style="width: 50px; height: 68px;">
                    <input id="ButtonReset" type="reset" value="reset" /><asp:Button ID="ButtonSubmit" runat="server" OnClick="ButtonSubmit_Click" Text="Submit" />
                    </td>
            <td style="width: 237px; height: 68px;" class="modal-sm">&nbsp;</td>
            <td style="width: 3px; height: 68px;" class="modal-sm">&nbsp;</td>
            <td style="width: 90px; height: 68px;" class="modal-sm">&nbsp;</td>
